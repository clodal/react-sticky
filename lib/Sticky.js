...
var Sticky = function (_Component) {
  ...
  function Sticky() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Sticky.__proto__ || Object.getPrototypeOf(Sticky)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var isTopSticky = Math.min(0, distanceFromTop) <= -_this.props.topOffset && distanceFromBottom > -_this.props.bottomOffset;

      var isBottomSticky = Math.min(0, distanceFromTop) <= -_this.props.topOffset && distanceFromBottom > -_this.props.bottomOffset;
