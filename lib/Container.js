  ...
  _createClass(Container, [{
    ...
    value: function componentDidMount() {
      ...
      this.events.forEach(function (event) {
        return window.addEventListener(event, _this2.notifySubscribers, _this2.capture);
      });
    }
  }, {
    ...
    value: function componentWillUnmount() {
      ...
      this.events.forEach(function (event) {
        return window.removeEventListener(event, _this3.notifySubscribers, _this3.capture);
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ["capture"]);
